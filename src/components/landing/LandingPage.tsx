    ...
    <div style={{ display: 'flex', gap: '10px', marginBottom: '24px' }}>
      ...
      <div
        style={{
          ...
          border: '0.5px solid rgba(255,78,122,0.18)',
          flex: 1
        }}
      >
        <span
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
        ...
        <div
          style={{
            ...
            padding: '6px 14px',
            borderRadius: '99px',
            border: '0.5px solid rgba(77,255,195,0.25)',
        ...
        >
          Your finances, <span style={{ color: '#4DFFC3' }}>fully under</span>{' '}
          control
        </h1>
        ...
        >
          No credit card&nbsp;·&nbsp;Free forever plan&nbsp;·&nbsp;Cancel
          anytime
        </p>
      </div>
    ...
    >
      {STATS.map(({ main, unit, label }, i) => (
        ...
        >
          ...
          >
            {main}
            <span style={{ color: '#4DFFC3' }}>{unit}</span>
          </p>
          <p
            style={{
              fontFamily: 'var(--font-mono)',
  ...
  <section id='features' style={{ borderTop: SECTION_BORDER }}>
    <div style={{ ...MAX_W, padding: '96px 40px' }}>
      ...
      {/* Bento grid:
          ...
          row 2 — [Visual analytics] [Secure] [Instant setup]
          row 3 — [Open source · span 3, horizontal banner]       */}
      <div
        style={{
          display: 'grid',
      ...
      >
        {FEATURES.map(({ icon: Icon, accent, tint, title, desc }, idx) => {
          ...
          const isFull = idx === 5 // Open source — full-width banner
            ...
            <div
              ...
              style={{
                ...
                background: isHero
                  ? tint
                  : isFull
                    ? 'rgba(30,200,255,0.04)'
                    : 'var(--color-bg-surface)',
                border: `0.5px solid ${
                  isHero
                    ? 'rgba(77,255,195,0.18)'
                    : isFull
            ...
            >
              ...
              <div
                style={{
                  ...
                  alignItems: 'center',
                  justifyContent: 'center',
                  width: isHero ? '52px' : '44px',
                  height: isHero ? '52px' : '44px',
                  borderRadius: '12px',
                  background: tint,
                  flexShrink: 0
                }}
              ...
              {isFull && (
                <a
                  ...
                  style={{
                    ...
                    padding: '8px 18px',
                    borderRadius: '10px',
                    border: '0.5px solid rgba(30,200,255,0.3)',
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = 'rgba(30,200,255,0.14)'
                    e.currentTarget.style.borderColor = 'rgba(30,200,255,0.5)'
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background = 'rgba(30,200,255,0.08)'
                    e.currentTarget.style.borderColor = 'rgba(30,200,255,0.3)'
                  }}
                >
            ...
            {(['signin', 'signup'] as const).map((m) => (
              <button
                ...
                style={{
                  ...
                  fontSize: '14px',
                  background:
                    mode === m ? 'rgba(77,255,195,0.06)' : 'transparent',
